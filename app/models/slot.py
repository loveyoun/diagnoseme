...
class AppointmentSlot(Common):
    id: int = fields.BigIntField(primary_key=True)
    hospital: int = fields.ForeignKeyField("models.Hospital", related_name="appointment_slots",
                                           on_delete=fields.RESTRICT)
    doctor: int | None = fields.ForeignKeyField("models.Doctor", related_name="appointment_slots",
